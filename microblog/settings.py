...
BLEACH_ALLOWED_TAGS = ['p', 'b', 'i', 'u', 'em', 'strong', 'a', 's', 'pre', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'address', 'div', 'ol', 'ul', 'li', 'table', 'sub', 'sup', 'tbody', 'tr', 'td']

# Which HTML attributes are allowed
BLEACH_ALLOWED_ATTRIBUTES = ['href', 'title', 'style', 'border', 'cellpadding', 'cellspacing',]

# Which CSS properties are allowed in 'style' attributes (assuming style is
# an allowed attribute)
BLEACH_ALLOWED_STYLES = [
    'font-family', 'font-weight', 'text-decoration', 'font-variant', 'text-align', 'margin-left', 'margin-right', 'width'
]
